 ...
 *
 * STM32_SDC_USE_SDIO: selects the SDIO peripheral (4-bit) over SPI-MMC.
 * Required for the WeAct STM32F405 board: SD slot is wired over SDIO
 * (PC8-PC12 = D0-D3/CK, PD2 = CMD, PA8 = card detect active-low).
 *
 * DMA: SDIO uses DMA2 Stream3 (channel 4) by default on STM32F4.
 * Verified no conflict with other STM32_xxx_DMA_STREAM entries in this file.
 */
